...
train_input_data = train.drop('college', axis=1)  # Drop 'college' column from train_input_data
print("train input data", train_input_data)
test_output_data = test['college']
print("test Output data", test_output_data)
test_input_data = test.drop('college', axis=1)  # Drop 'college' column from test_input_data
